<template>
  <div class="form-wrapper">
    ...
    <v-form v-else v-model="valid">
      ...
      <v-text-field label="Phone"  v-mask="'(###)###-####'"  required :rules="phoneRules" v-model="phone"></v-text-field>
...
<script>
import { mask } from "vue-the-mask"; //is this where this goes???

export default {
  directives: { //is this where this goes???
    mask
  },
  data() {
    return {
      ...
      phoneRules: [
        ...
        phone => phone.length >= 7 || "Phone number should be at least 7 digit"
      ]
    };
  },
  methods: {
